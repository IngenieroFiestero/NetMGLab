...
for (var i = 0; i < objectTypeResults.textSequence.length; i++) {
        assert.deepEqual(smi.parseObjectType(objectTypeResults.textSequence[i]).returned, objectTypeResults.results[i].returned, 'Error in OBJECT TYPE test: ' + objectTypeResults.textSequence[i]);
}*/
