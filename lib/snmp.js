/**
 * Hay que rehacer el modulo SNMP, modulo ASN1 y encoders BER etc para poder intercomunicarse. El modulo SMI para poder exportar ASN1 en un lenguaje mas humano tendra que ser hecho de 0.
 */
...
function Packet(version,comm) {
    this.version = version || versions.SNMPv2c;
    this.community = comm || 'public';
    this.pdu = new PDU();
}
